...
export default function Function5() {
    ...
    return (
        <Container>
            <Title>히어로봇 감정 인식 기능</Title>

            <CaptureButtonStyle2 onPress={() => handleMove("face_recognition")}>
                <CaptureButtonText>감정 인식 시작</CaptureButtonText>
            </CaptureButtonStyle2>

            <CaptureButtonStyle3 onPress={() => handleMove("face_recognition_stop")}>
                <CaptureButtonText>감정 인식 중지</CaptureButtonText>
            </CaptureButtonStyle3>
